...
const Contact = () => {
    return (
        <div className='border-t border-t-stone-700 px-10 py-10'>
            <h2 className="text-center text-4xl text-stone-400 sm:mb-20">Get in Touch</h2>
            <div className="grid lg:grid-cols-4 gap-4">
                <div className='flex flex-col items-center'>
                    <img src={logo} alt="Company" className='my-8 lg:my-15 w-100 h-auto' />
                </div>
                <div>
                ...
                <div className='mx-auto'>
                    ...
                    <div className="flex justify-start items-start gap-10 sm:gap-10 my-8 lg:my-15">
                        ...
                        <a target='_blank' rel='noopener noreferrer' href="https://www.instagram.com/parsa_____official?utm_source=qr&igsh=MTB1NXE1cTN3YWR1OQ==" aria-label="Instagram">
                ...
                <div className='mb-10'>
                    ...
                    <p className="mt-3 px-2 sm:px-4 py-2 text-stone-600 text-sm sm:text-base">I'm a passionate and detail-oriented Computer Science student at Astana IT University, specializing in Frontend Web Development using modern technologies like React.js, Tailwind CSS, and JavaScript (ES6+).</p>
                </div>
            </div>
            <hr />
